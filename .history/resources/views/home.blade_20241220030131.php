                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::sum('total_remain'), 2) }}
                                </h4>
                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    $count_invoices2 = \App\invoices::where('status', 2)->count();
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('status', 1)->sum('total_remain'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\invoices::where('status', 1)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    @php
                                        $count_all= \App\invoices::count();
                                        $count_invoices1 = \App\invoices::where('status', 1)->count();
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('status', 3)->sum('total_remain'), 2) }}

                                </h4>
                                <p class="mb-0 tx-12 text-white op-7">
                                    {{ \App\invoices::where('status', 3)->count() }}
                                </p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
