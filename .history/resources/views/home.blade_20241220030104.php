                        ...
                        <div class="d-flex">
                            <div class="">
                                <h3 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 2)->sum('total_remain'), 2) }}
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 1)->sum('total_remain'), 2) }}
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    {{ number_format(\App\invoices::where('Value_Status', 3)->sum('total_remain'), 2) }}
