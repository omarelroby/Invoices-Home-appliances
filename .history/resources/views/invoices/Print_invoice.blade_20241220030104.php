                            ...
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        @php
                                        $total_remain = $invoices->Amount_collection + $invoices->Amount_Commission ;
                                        @endphp
                                        <td class="tx-right">
                                            {{ number_format($total_remain, 2) }}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2"> {{ number_format($total_remain, 2) }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tx-right" colspan="2">
                                            <h4 class="tx-primary tx-bold">{{ number_format($invoices->total_remain, 2) }}</h4>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
