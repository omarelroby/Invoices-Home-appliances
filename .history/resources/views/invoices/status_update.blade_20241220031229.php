                ...
                <div class="card-body">
                    <form action="{{ route('Status_Update', ['id' => $invoices->id]) }}" method="post" autocomplete="off">
                        ...
                        <div class="col-4">
                            ...
                            <input readonly class="form-control fc-datepicker" name="pay_date" placeholder="YYYY-MM-DD"
                                   type="text" value="{{date('Y-M-D')}}" required>
                        </div>
                        <div class="col-4">
                            <label>المبلغ المتبقي</label>
                            <input class="form-control" readonly value="{{$invoices->total_remain_remain}}" name="total_remain_remain" id="total_remain_remain" type="text" placeholder="المبلغ" required />
                        </div>
                        <div class="col-4">
