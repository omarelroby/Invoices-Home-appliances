				...
				<div class="row row-sm">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
						<div class="card">
							<div class="card-body iconfont text-right">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-3">total_remain visits</h4>
									<i class="mdi mdi-dots-vertical"></i>
								</div>
								<div class="d-flex mb-0">
									<div class="">
				...
				<div class="row row-sm">
						...
						<div class="card ">
							<div class="card-body">
								<div class="card-widget">
									<h6 class="mb-2">total_remain Tax</h6>
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
						<div class="card">
							<div class="card-body">
								<div class="card-widget">
									<h6 class="mb-2">total_remain Profit</h6>
					...
					<div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
						<div class="card ">
							<div class="card-body">
								<div class="card-widget">
									<h6 class="mb-2">total_remain Sales</h6>
					...
					<div class="col-sm-6 col-lg-6 col-xl-3">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<div class="col">
										<div class="">total_remain Revenue</div>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								...
								<h6 class="mb-1 text-muted">total_remain Revenue</h6>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body">
								...
								<h6 class="mb-1 text-muted">total_remain Profit</h6>
					...
					<div class="col-xl-3 col-lg-6 col-sm-6 col-md-6">
						<div class="card text-center">
							<div class="card-body ">
								...
								<h6 class="mb-1 text-muted">total_remain Investiment</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="plan-card text-center">
									...
									<h6 class="text-drak text-uppercase mt-2">total_remain Shares</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="plan-card text-center">
									...
									<h6 class="text-drak text-uppercase mt-2">total_remain Comments</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="plan-card text-center">
									...
									<h6 class="text-drak text-uppercase mt-2">total_remain Likes</h6>
						...
						<div class="card">
							<div class="card-body">
								<div class="plan-card text-center">
									...
									<h6 class="text-drak text-uppercase mt-2">total_remain Views</h6>
